...
vim.keymap.set("n", "<leader>ft", "<cmd>Telescope colorscheme<CR>", { desc = "Telescope colorscheme select" })
vim.keymap.set("n", "<leader>ff", telescope.find_files, { desc = "Telescope file select" })
